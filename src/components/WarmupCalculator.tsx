...
const WarmupMascotIcon = () => (
  <svg width="48" height="48" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_warmup)"><path opacity="0.1" d="M12 26.6C15.645 26.6 18.6 23.645 18.6 20C18.6 16.355 15.645 13.4 12 13.4C8.355 13.4 5.4 16.355 5.4 20C5.4 23.645 8.355 26.6 12 26.6Z" fill="#3B82F6"/><path d="M12 26C15.314 26 18 23.314 18 20C18 16.686 15.314 14 12 14C8.686 14 6 16.686 6 20C6 23.314 8.686 26 12 26Z" fill="#F1F5F9"/><path d="M12 24.56C14.32 24.56 16.2 23.056 16.2 21.2C16.2 19.344 14.32 17.84 12 17.84C9.68 17.84 7.8 19.344 7.8 21.2C7.8 23.056 9.68 24.56 12 24.56Z" fill="#E2E8F0"/><path opacity="0.6" d="M8.4 22.88C9.46 22.88 10.32 22.02 10.32 20.96C10.32 19.9 9.46 19.04 8.4 19.04C7.34 19.04 6.48 19.9 6.48 20.96C6.48 22.02 7.34 22.88 8.4 22.88Z" fill="#CBD5E1"/><path opacity="0.6" d="M15.6 22.88C16.66 22.88 17.52 22.02 17.52 20.96C17.52 19.9 16.66 19.04 15.6 19.04C14.54 19.04 13.68 19.9 13.68 20.96C13.68 22.02 14.54 22.88 15.6 22.88Z" fill="#CBD5E1"/><path d="M10.2 20.24C10.664 20.24 11.04 19.864 11.04 19.4C11.04 18.936 10.664 18.56 10.2 18.56C9.736 18.56 9.36 18.936 9.36 19.4C9.36 19.864 9.736 20.24 10.2 20.24Z" fill="#1E293B"/><path d="M13.8 20.24C14.264 20.24 14.64 19.864 14.64 19.4C14.64 18.936 14.264 18.56 13.8 18.56C13.336 18.56 12.96 18.936 12.96 19.4C12.96 19.864 13.336 20.24 13.8 20.24Z" fill="#1E293B"/><path d="M10.2 22.16C11.4 22.72 12.6 22.72 13.8 22.16" stroke="#64748B" strokeWidth="2.5" strokeLinecap="round"/></g>
    <defs><clipPath id="clip0_warmup"><rect width="24" height="24" fill="white" transform="translate(0 8)"/></clipPath></defs>
  </svg>
);
